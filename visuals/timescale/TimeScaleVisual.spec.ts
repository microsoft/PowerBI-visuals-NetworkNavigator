...
import TimeScaleVisual from "./TimeScaleVisual";
import * as $ from "jquery";

describe('TimeScaleVisual', () => {
    var parentEle;
    beforeEach(() => {
    ...
    let createVisual = () => {
        let instance = new TimeScaleVisual(true);
    ...
    describe("coerceDate", () => {
        it("should coerce 2014 as a date object", () => {
            expect(TimeScaleVisual.coerceDate(2014).getFullYear()).to.eq(2014); 
        });
        it("should coerce '2014' as a date object", () => {
            expect(TimeScaleVisual.coerceDate('2014').getFullYear()).to.eq(2014); 
        });
        it("should coerce iso date '1999-03-16T22:29:03.221Z' as the correct date object", () => {
            let result = TimeScaleVisual.coerceDate('1999-03-16T22:29:03.221Z');
